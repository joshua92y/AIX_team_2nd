...
const SHOPDASH_LANGUAGE_TEXTS = {
  ...
  en: {
    ...
    businessTypes: {
      ...
      '건강기능식품전문판매업': 'Health Functional Food Sales',
  ...
  es: {
    ...
    businessTypes: {
      ...
      '건강기능식품전문판매업': 'Venta de Alimentos Funcionales',
