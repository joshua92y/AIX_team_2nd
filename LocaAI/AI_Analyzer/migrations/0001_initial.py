...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunSQL(
            "ALTER TABLE AI_Analyzer_analysisrequest ADD COLUMN business_type_id INTEGER REFERENCES business_type(id);",
            reverse_sql="ALTER TABLE AI_Analyzer_analysisrequest DROP COLUMN business_type_id;"
        ),
    ]
