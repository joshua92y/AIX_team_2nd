...
class BaseGISAdmin(admin.GISModelAdmin):
    ...
    def get_geometry_info(self, obj):
        ...
        if hasattr(obj, "geom") and obj.geom:
            geom_type = (
                obj.geom.geom_type if hasattr(obj.geom, "geom_type") else "Unknown"
            )
    ...
    def get_coordinate_detail(self, obj):
        ...
        if original_x and original_y:
            ...
            try:
                ...
                transformer_to_mercator = pyproj.Transformer.from_crs(
                    crs_4326, crs_3857, always_xy=True
                )
    ...
    def get_queryset(self, request):
        ...
        if (
            ...
            and "changelist" in request.resolver_match.url_name
        ):
...
class TempForeignAdmin(BaseGISAdmin):
    ...
    fieldsets = (
        ("단기체류외국인 정보", {"fields": ("총생활인구수", "중국인체류인구수")}),
        ("좌표 정보", {"fields": ("get_coordinate_detail",), "classes": ("collapse",)}),
        ("지리 정보", {"fields": ("geom",)}),
    )
...
class LongForeignAdmin(BaseGISAdmin):
    ...
    fieldsets = (
        ("장기체류외국인 정보", {"fields": ("총생활인구수", "중국인체류인구수")}),
        ("좌표 정보", {"fields": ("get_coordinate_detail",), "classes": ("collapse",)}),
        ("지리 정보", {"fields": ("geom",)}),
    )
...
class StorePointAdmin(BaseGISAdmin):
    ...
    fieldsets = (
        ("상점 정보", {"fields": ("uptaenm", "service", "area")}),
        ("좌표 정보", {"fields": ("x", "y", "get_coordinate_detail")}),
        ("지리 정보", {"fields": ("geom",)}),
    )
...
class SchoolAdmin(BaseGISAdmin):
    ...
    fieldsets = (
        ...
        ("연락처 정보", {"fields": ("phone_number", "fax_number", "homepage")}),
        ("주소 정보", {"fields": ("postal_code", "road_address", "detail_address")}),
        ("좌표 정보", {"fields": ("x", "y", "get_coordinate_detail")}),
        ("지리 정보", {"fields": ("geom",)}),
    )
...
class PublicBuildingAdmin(BaseGISAdmin):
    ...
    fieldsets = (
        ("건물 정보", {"fields": ("dgm_nm", "lclas_cl", "mlsfc_cl", "dgm_ar")}),
        ("좌표 정보", {"fields": ("get_coordinate_detail",), "classes": ("collapse",)}),
        ("지리 정보", {"fields": ("geom",)}),
    )
...
class EditableStorePointAdmin(BaseGISAdmin):
    ...
    fieldsets = (
        ("상점 정보", {"fields": ("storename", "uptaenm", "address", "phone")}),
        (
            "위치 정보",
            {
