...
class AnalysisRequestAdmin(admin.ModelAdmin):
    """분석 요청 관리"""
    list_display = ('id', 'address', 'business_type', 'area', 'service_type', 'created_at')
    ...
    fieldsets = (
        ('기본 정보', {
            'fields': ('address', 'area', 'business_type', 'service_type')
        }),
        ('좌표 정보', {
...
class AnalysisResultAdmin(admin.ModelAdmin):
    """분석 결과 관리"""
    list_display = ('id', 'get_address', 'get_business_type', 'life_pop_300m', 'working_pop_300m', 'competitor_300m', 'created_at')
    ...
    fieldsets = (
        ...
        ('외국인 분석', {
            'fields': (
                ('temp_foreign_1000m', 'temp_foreign_cn_300m', 'temp_foreign_cn_1000m'),
                ('long_foreign_300m', 'long_foreign_1000m', 'long_foreign_cn_1000m'),
            ),
            'classes': ('collapse',)
        }),
        ('주변 시설', {
